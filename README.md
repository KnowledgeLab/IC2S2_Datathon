...
The population mobility dataset is provided by SafeGraph. Below are a few notes which may be helpful when using the data.

Safegraph Mobility
Include 23 zip files covering all data files. 
Zip files are named by single uppercase letters. 
...
SafeGraph, SafeGraph Mobility Dataset, [Unpublished Raw Data]. SafeGraph. 
